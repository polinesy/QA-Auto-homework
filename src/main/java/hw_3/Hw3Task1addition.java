...
public class Hw3Task1addition {
    ...
    public static class LocatorsW3Schools1 {
        ...
        public static final By noteText = By.xpath("/html/body/div[2]/p");
    }
    ...
    public static void openAllPages(WebDriver driver) throws InterruptedException {
        ...
        driver.get(Urls1.googleSearch);
        WebElement textArea1 = driver.findElement(LocatorsGoogle1.textArea1);

        actions.sendKeys(textArea1, Urls1.guinnessPage).sendKeys(Keys.ENTER).perform();
        Thread.sleep(2000);

        WebElement link1 = driver.findElement(LocatorsGoogle1.link1);
        ...
        WebElement textArea2 = driver.findElement(LocatorsGoogle1.textArea2);


        driver.findElement(LocatorsGoogle1.clearButton).click();
        actions.sendKeys(textArea2, Urls1.alertsDemo).sendKeys(Keys.ENTER).perform();

        WebElement link2 = driver.findElement(LocatorsGoogle1.link2);
   ...
   // выполняем действия на странице школы
    public static void sendName (WebDriver driver) throws InterruptedException {
        ...
        WebElement firstName = driver.findElement(LocatorsW3Schools1.firstNameW3);
        WebElement lastName = driver.findElement(LocatorsW3Schools1.lastNameW3);
        WebElement submitButton = driver.findElement(LocatorsW3Schools1.submitButton);
        ...
        submitButton.click();
        Thread.sleep(3000);
        WebElement noteText = driver.findElement(LocatorsW3Schools1.noteText);
    ...
    public static void fillRegistrationForm (WebDriver driver) {
        ...
        //Thread.sleep(3000);
        waiters.waitForVisibility(driver.findElement(LocatorsGuinness1.lastNameG)).sendKeys("Polina");
        driver.findElement(LocatorsGuinness1.firstNameG).sendKeys("Sydorenko");
        driver.findElement(LocatorsGuinness1.birthDay).sendKeys("07");
        driver.findElement(LocatorsGuinness1.birthMonth).sendKeys("06");
        driver.findElement(LocatorsGuinness1.birthYear).sendKeys("1997");

        new Select(driver.findElement(LocatorsGuinness1.countrySelector)).selectByVisibleText("Ukraine");

        driver.findElement(LocatorsGuinness1.stateSelector).sendKeys("Kyiv");

        driver.findElement(LocatorsGuinness1.emailAddress).sendKeys("mail@mail.cim");
        driver.findElement(LocatorsGuinness1.emailAddressConfirm).sendKeys("mail@mail.cim");

        driver.findElement(LocatorsGuinness1.password).sendKeys("12345");
        Actions actions = new Actions(driver);
        driver.findElement(LocatorsGuinness1.passwordConfirm).sendKeys("1234567");
        actions.sendKeys(Keys.ENTER).perform();

        System.out.println(driver.findElement(LocatorsGuinness1.passwordText).getText());
